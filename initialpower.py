...
class InitialPowerParams(CAMB_Structure):
    ...
    def set_params(self, As=2e-9, ns=0.96, nrun=0, nrunrun=0, r=0, nt=None, ntrun=0,
                   pivot_scalar=0.05, pivot_tensor=0.05, parameterization=tensor_param_rpivot, kXpivot = 0.01, epsX = 0.,jXpivot = 0.01):
        """
        ...
        :param kXpivot: modified power at k
        :param epsX: amplitude of modified power
